...
// suddenly appear amongst the tests you wrote for that thing only.
   ...
   #include "include/tools/remove_strings.h"
   #include "include/tools/random.h"
   #include "include/tools/trim_punctuation.h"
   #include "include/tools/string_start_end.h"
   #include "include/tools/string_case.h"
   #include "include/tools/string_replace.h"
   #include "include/tools/get_substring.h"
