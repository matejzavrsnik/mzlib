...
#ifndef MZLIB_UNITS_STRONG_FOUNDATION_H
#define MZLIB_UNITS_STRONG_FOUNDATION_H
...
#define MZ_QUANTITY_DEFINITION_START(q_class, q_basic) \
...
#define MZ_QUANTITY_DEFINITION_END(q_class, q_basic) \
protected: \
...
#define MZ_UNIT_DEFINITION(q_class, q_short, q_factor, q_basic) \
...
#endif // MZLIB_UNITS_STRONG_FOUNDATION_H
