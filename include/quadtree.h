...
namespace mzlib
{
    ...
    public:
        ...
        // Following is just for easier coding and average developer will expect
        ...
        bool add(T body, math::cvector2d location) { return m_root->add(body, location); }
        bool is_in(math::cvector2d location) const { return m_root->is_in(location); }

        iterator        begin()                    { return iterator(m_root.get()); }
        iterator        end()                      { return iterator(nullptr); }
        
        it_postorder    begin_nodes_postorder()    { return it_postorder(m_root.get()); }
        it_postorder    end_nodes_postorder()      { return it_postorder(nullptr); }
        
        it_breadthfirst begin_nodes_breadthfirst() { return it_breadthfirst(m_root.get()); }
        it_breadthfirst end_nodes_breadthfirst()   { return it_breadthfirst(nullptr); }
    };
