...
namespace mzlib
{
    ...
    public:
        ...
        quadtree_it_breadthfirst(quadtree_it_breadthfirst&&) = default; // make default move constructor
        quadtree_it_breadthfirst(const quadtree_it_breadthfirst&) = default; // make default copy constructor
