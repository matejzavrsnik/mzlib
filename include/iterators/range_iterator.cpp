...
TEST(range_iterator, next_same_size)
{
   ...
   ASSERT_EQ(assumed_current.beg()+1, next.beg());
...
TEST(range_iterator, complete_run)
{
   ...
   // 2 x range size 4
   ASSERT_EQ(ranges[0].beg(), v1);
   ASSERT_EQ(ranges[0].end(), v5);
   
   ASSERT_EQ(ranges[1].beg(), v2);
   ASSERT_EQ(ranges[1].end(), v_end);
   
   // 3 x range size 3
   ASSERT_EQ(ranges[2].beg(), v1);
   ASSERT_EQ(ranges[2].end(), v4);
   
   ASSERT_EQ(ranges[3].beg(), v2);
   ASSERT_EQ(ranges[3].end(), v5);
   
   ASSERT_EQ(ranges[4].beg(), v3);
   ASSERT_EQ(ranges[4].end(), v_end);
   
   // 5 x range size 2
   ASSERT_EQ(ranges[5].beg(), v1);
   ASSERT_EQ(ranges[5].end(), v3);
   
   ASSERT_EQ(ranges[6].beg(), v2);
   ASSERT_EQ(ranges[6].end(), v4);
   
   ASSERT_EQ(ranges[7].beg(), v3);
   ASSERT_EQ(ranges[7].end(), v5);
   
   ASSERT_EQ(ranges[8].beg(), v4);
