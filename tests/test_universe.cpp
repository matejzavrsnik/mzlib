...
TEST_F(fixture_universe, sun_force_on_earth)
{
   ...
   mzlib::cvector2d f_earth = universe.find_body(earth)->data.gravity;
...
TEST_F(fixture_universe, sun_earth_month_travel_barneshut_with_quotient_more_than_0)
{
   ...
   mzlib::cvector2d earth_location_quarter_later = universe.find_body(earth)->mass_centre.location;
...
TEST_F(fixture_universe, long_earth_around_the_sun)
{
   ...
   mzlib::cvector2d earth_location_year_later = universe.find_body(earth)->mass_centre.location;
...
TEST_F(fixture_universe, moving_object_while_gravity_simulation_running)
{
   ...
   // measure location
   mzlib::cvector2d earth_location_without_move = universe.find_body(earth)->mass_centre.location;
   ...
   // measure location
   mzlib::cvector2d earth_location_with_move = universe.find_body(earth)->mass_centre.location;
