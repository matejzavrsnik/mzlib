...
TEST_F(fixture_utilities, compare_equal_doubles_for_equality) 
{
   ASSERT_TRUE(dbl(13.3L).equals(13.3L));
}

TEST_F(fixture_utilities, compare_different_doubles_for_equality) 
{
   ASSERT_FALSE(dbl(13.3L).equals(13.2L));
}

TEST_F(fixture_utilities, compare_ranges_of_nearly_equals_doubles_for_equality) {
...
TEST_F(fixture_utilities, compare_equal_doubles_for_equality_within_epsilon) 
{
   ASSERT_TRUE(dbl(13.3).equals(13.2).within_epsilon(0.2));
}

TEST_F(fixture_utilities, compare_different_doubles_for_equality_within_epsilon) 
{
...
TEST_F(fixture_utilities, get_random_integer) 
{
...
TEST_F(fixture_utilities, get_random_double_between_0_1) 
{
...
TEST_F(fixture_utilities, get_random_element) 
{
...
TEST_F(fixture_utilities, unique_basic) 
{
   cunique a;
   cunique b;
   ASSERT_NE(a.id(), b.id()); 
...
TEST_F(fixture_utilities, unique_on_copy) 
{
   cunique a;
   cunique b;
   cunique c(a);
