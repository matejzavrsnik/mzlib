...
class test_supersafe_number : public ::testing::Test {
protected:

  test_supersafe_number() {}
  virtual ~test_supersafe_number() {}
...
TEST_F(test_supersafe_number, keys_are_different) {
...
TEST_F(test_supersafe_number, conversion_to_raw_number) {
    s_int number = 13;
    int stored = number;
    ASSERT_EQ(13, stored);
...
TEST_F(test_supersafe_number, computation) {
    s_int number1 = 13;
