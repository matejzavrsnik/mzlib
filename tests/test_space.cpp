...
class test_space : public ::testing::Test {
 protected:
  ...
  mzlib::cspace::ptr space = std::make_shared<mzlib::cspace>();
...
{
    std::shared_ptr<mzlib::cbody> big_ben = std::make_shared<mzlib::cbody>();
    big_ben->set_mass(10e8_kg); // 10e8 kg
    
    std::shared_ptr<mzlib::cbody> empire_state_building = std::make_shared<mzlib::cbody>();
    ...
    mzlib::math::cvector2d f_empire_state_building = empire_state_building->get_force();
    mzlib::math::cvector2d f_big_ben = big_ben->get_force();
...
{
    std::shared_ptr<mzlib::cbody> sun = std::make_shared<mzlib::cbody>();
    sun->set_mass(mzlib::consts::sun_mass); // 1.99e30
    
    std::shared_ptr<mzlib::cbody> earth = std::make_shared<mzlib::cbody>();
    ...
    mzlib::math::cvector2d f_sun = sun->get_force();
    mzlib::math::cvector2d f_earth = earth->get_force();
...
TEST_F(test_space, long_earth_around_the_sun)
{
    ...
    earth->set_mass(mzlib::consts::earth_mass);
    earth->set_velocity({mzlib::consts::earth_speed_aphelion,0});
