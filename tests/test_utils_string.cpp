...
TEST_F(fixture_utils_string, wagner_fisher_distance_basic) 
{
   std::string str1 = "matej";
   std::string str2 = "mtey";
   
   int result = mzlib::util::wagner_fisher_distance(str1, str2);
   
   // 1 omitted a, 1 substituted y : edit distance = 2
   ASSERT_EQ(2, result);
}

TEST_F(fixture_utils_string, wagner_fisher_distance_equal) 
{
...
TEST_F(fixture_utils_string, wagner_fisher_distance_a_complicated_one) 
{
   std::string str1 = "matej zavrsnik likes star trek but not so much the original series because it is too naive.";
...
TEST_F(fixture_utils_string, wagner_fisher_distance_substition_first) 
{
   std::string str1 = "matej zavrsnik likes star trek but not so much the original series because it is too naive.";
...
TEST_F(fixture_utils_string, wagner_fisher_distance_substition_last) 
{
   std::string str1 = "matej zavrsnik likes star trek but not so much the original series because it is too naive.";
   std::string str2 = "matej zavrsnik likes star trek but not so much the original series because it is too naive!";
...
TEST_F(fixture_utils_string, wagner_fisher_distance_substition_middle) 
{
   std::string str1 = "matej zavrsnik likes star trek but not so much the original series because it is too naive.";
...
TEST_F(fixture_utils_string, wagner_fisher_distance_deletion_first) 
{
   std::string str1 = "matej zavrsnik likes star trek but not so much the original series because it is too naive.";
...
TEST_F(fixture_utils_string, wagner_fisher_distance_deletion_last) 
{
   std::string str1 = "matej zavrsnik likes star trek but not so much the original series because it is too naive.";
   std::string str2 = "matej zavrsnik likes star trek but not so much the original series because it is too naive";
...
TEST_F(fixture_utils_string, wagner_fisher_distance_deletion_middle) 
{
   std::string str1 = "matej zavrsnik likes star trek but not so much the original series because it is too naive.";
...
TEST_F(fixture_utils_string, wagner_fisher_distance_insertion_first) 
{
   std::string str1 = "matej zavrsnik likes star trek but not so much the original series because it is too naive.";
...
TEST_F(fixture_utils_string, wagner_fisher_distance_insertion_last) 
{
   std::string str1 = "matej zavrsnik likes star trek but not so much the original series because it is too naive.";
...
TEST_F(fixture_utils_string, wagner_fisher_distance_insertion_middle) 
{
   std::string str1 = "matej zavrsnik likes star trek but not so much the original series because it is too naive.";
