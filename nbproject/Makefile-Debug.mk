...
${OBJECTDIR}/tests/extension/libxmlpp.o: tests/extension/libxmlpp.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/glibmm-2.4 -I/usr/lib64/glibmm-2.4/include -I/usr/include/libxml++-2.6 -I/usr/lib64/libxml++-2.6/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/extension/libxmlpp.o tests/extension/libxmlpp.cpp

${OBJECTDIR}/tests/extension/libxmlpp_datashelf.o: tests/extension/libxmlpp_datashelf.cpp
	${MKDIR} -p ${OBJECTDIR}/tests/extension
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/glibmm-2.4 -I/usr/lib64/glibmm-2.4/include -I/usr/include/libxml++-2.6 -I/usr/lib64/libxml++-2.6/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/extension/libxmlpp_datashelf.o tests/extension/libxmlpp_datashelf.cpp

${OBJECTDIR}/tests/extension/sdl_image_texture.o: tests/extension/sdl_image_texture.cpp
	${MKDIR} -p ${OBJECTDIR}/tests/extension
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/glibmm-2.4 -I/usr/lib64/glibmm-2.4/include -I/usr/include/libxml++-2.6 -I/usr/lib64/libxml++-2.6/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/extension/sdl_image_texture.o tests/extension/sdl_image_texture.cpp
...
${OBJECTDIR}/tests/string/is_just_whitespace.o: tests/string/is_just_whitespace.cpp
	${MKDIR} -p ${OBJECTDIR}/tests/string
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/glibmm-2.4 -I/usr/lib64/glibmm-2.4/include -I/usr/include/libxml++-2.6 -I/usr/lib64/libxml++-2.6/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/string/is_just_whitespace.o tests/string/is_just_whitespace.cpp
...
${OBJECTDIR}/tests/string/trim_nonalpha.o: tests/string/trim_nonalpha.cpp
	${MKDIR} -p ${OBJECTDIR}/tests/string
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/glibmm-2.4 -I/usr/lib64/glibmm-2.4/include -I/usr/include/libxml++-2.6 -I/usr/lib64/libxml++-2.6/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/string/trim_nonalpha.o tests/string/trim_nonalpha.cpp
...
${OBJECTDIR}/tests/tools/fluent_datashelf.o: tests/tools/fluent_datashelf.cpp
	${MKDIR} -p ${OBJECTDIR}/tests/tools
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/gtest -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/glibmm-2.4 -I/usr/lib64/glibmm-2.4/include -I/usr/include/libxml++-2.6 -I/usr/lib64/libxml++-2.6/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tests/tools/fluent_datashelf.o tests/tools/fluent_datashelf.cpp
